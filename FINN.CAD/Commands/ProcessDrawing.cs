...
[assembly: CommandClass(typeof(FINN.CAD.ProcessDrawing))]

namespace FINN.CAD
{
    public class ProcessDrawing
    {
        public static ProcessNode Node { get; set; }
        public static string TestString = "Greetings, Welcome to AutoCAD .NET!!!";
